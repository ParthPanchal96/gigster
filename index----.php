...
<script src="<?php echo $serverpath;?>js/infowindow.js" charset="UTF-8" type="text/javascript"></script>
<script src="<?php echo $serverpath;?>js/onion.js" charset="UTF-8" type="text/javascript"></script>
<script src="<?php echo $serverpath;?>js/controls.js" charset="UTF-8" type="text/javascript"></script>
<script src="<?php echo $serverpath;?>js/stats.js" charset="UTF-8" type="text/javascript"></script>
...
<div id="menu-wrap" class="menu-back cbp-af-header cbp-af-header-shrink">
  <div class="container">
    <div class="sixteen columns">
      <div class="logo" style="font-size:29px; line-height:250%; font-weight:700;"><a href="#home" style="color:black;">Bettr</a></div>
...
<div  id="home">
  ...
  <div class="bgBox">
    ...
    <?php
		...
		$openid = new LightOpenID($serverpath);
		...
		$openid->returnUrl = "echo $serverpath;"
	 ?>
    <div class="social-top" style="padding: 15px 30px;" >
      <ul class="list-social" >
        ...
        <li style="background-color:#5B5B5B;"> <a href="<?php echo $openid->authUrl(); ?>" class="mwhite"><i class="fa fa-google"></i> Login with Google</a> </li>
...
<div id="about">
  <div class="container">
    ...
    <div class="clear"></div>
    <div data-sr-complete="true" data-sr-init="true" class="one-third column" data-scrollreveal="enter left and move 50px over 1s">
      <h6>WHAT WE DO.</h6>
      <p>Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.Praesent commodo arcu massa.</p>
    </div>
    <div data-sr-complete="true" data-sr-init="true" class="one-third column" data-scrollreveal="enter bottom and move 50px over 1s">
      <h6>WHAT WE ACHIEVE.</h6>
      <p>Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.Praesent commodo arcu massa.</p>
    </div>
    <div data-sr-complete="true" data-sr-init="true" class="one-third column" data-scrollreveal="enter right and move 50px over 1s">
      <h6>AT THE END.</h6>
      <p>Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.Praesent commodo arcu massa.</p>
    </div>
  </div>
