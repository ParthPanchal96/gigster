  ...
  <div class="container">
    <div class="sixteen columns">
      ...
      <ul class="slimmenu">
		...
		{
			?>
        <a class="fancyboxaddgig fancybox.iframe" href="<?=$serverpath;?>my-login.php" >Add A Gig</a>
        <?php
		}
		else
		{
			?>
			        <a href="<?=$serverpath;?>addgig" >Add A Gig</a>
			<?php
		}
		?>
        </li>
...
<div  id="home">
  ...
  <div class="bgBox">
	...
	?>
	<ul class="list-social" >
        <li style="background-color:#3b5998;"> <a href="<?php echo $serverpath;?>allgigs" class="mwhite">My Account</a> </li>
         <li style="background-color:#ff5a00;" class="gglclr"> <a href="<?php echo $serverpath;?>addagig" class="mwhite">Add A Gig</a> </li></ul>
	<?php	
	}
	  ?>
    </div>
