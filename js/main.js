(function () {
    ...
    G.notify = function (a) {
        var b = De(this);
        a = a + "";
        (b = pe(b, a)) ? b.Nc[Ub](b.rb): Fe(this, a)
    };
    ...
    Q[F].unbind = function (a) {
        var b = De(this),
            c = b[a];
        c && (c.Ah && delete Ge(c.Nc, c.rb)[Be(c.Ah)], this[a] = this.get(a), b[a] = null)
    };
    ...
    var Zf = Bd.ArrayBuffer ? new ArrayBuffer(8) : null;
    Bd.Uint8Array && Zf && new Uint8Array(Zf);
    Bd.Uint16Array && Zf && new Uint16Array(Zf);
    Bd.Uint32Array && Zf && new Uint32Array(Zf);
    Bd.Int8Array && Zf && new Int8Array(Zf);
    Bd.Int16Array && Zf && new Int16Array(Zf);
    Bd.Int32Array && Zf && new Int32Array(Zf);
    Bd.Float32Array && Zf && new Float32Array(Zf);
    Bd.Float64Array && Zf && new Float64Array(Zf);
    ...
    G.intersects = function (a) {
        var b = this.j,
            c = this.k;
        return this[pc]() || a[pc]() ? !1 : dg(this) ? dg(a) || a.j <= this.k || a.k >= b : dg(a) ? a.j <= c || a.k >= b : a.j <= c && a.k >= b
    };
    Ma(G, function (a) {
        -180 == a && (a = 180);
        var b = this.j,
            c = this.k;
        return dg(this) ? (a >= b || a <= c) && !this[pc]() : a >= b && a <= c
    });
    ra(G, function (a) {
        this[hc](a) || (this[pc]() ? this.j = this.k = a : eg(a, this.j) < eg(this.k, a) ? this.j = a : this.k = a)
    });

    function fg(a, b) {
        return 1E-9 >= l.abs(b.j - a.j) % 360 + l.abs(gg(b) - gg(a))
    }
    ...
    function gg(a) {
        return a[pc]() ? 0 : dg(a) ? 360 - (a.j - a.k) : a.k - a.j
    }
    G.Rb = function () {
        var a = (this.j + this.k) / 2;
        dg(this) && (a = Ud(a + 180, -180, 180));
        return a
    };
    ...
    function jg(a, b) {
        if (a) {
            ...
            c = a.lng();
            d = b.lng();
            360 <= d - c ? this.pa = new cg(-180, 180) : (c = Ud(c, -180, 180), d = Ud(d, -180, 180), this.pa = new cg(c, d))
        } else this.xa = new hg(1, -1), this.pa = new cg(180, -180)
    }
    ...
    jg[F].j = function (a) {
        if (a) {
            var b = this.xa,
                c = a.xa;
            a = (b[pc]() ? c[pc]() : 1E-9 >= l.abs(c.k - b.k) + l.abs(b.j - c.j)) && fg(this.pa, a.pa)
        } else a = !1;
        return a
    };
    jg[F].equals = jg[F].j;
    ...
    G.toSpan = function () {
        return new R(ig(this.xa), gg(this.pa), !0)
    };
    Qa(G, function () {
    ...
    L(pg, Q);
    pg[F].overrideStyle = function (a, b) {
        this.j.set(Be(a), b)
    };
    pg[F].revertStyle = function (a) {
    ...
    var sg = We(Ue(rg, "google.maps.Data.LineString", !0));

    function tg(a) {
        this.Z = jf(a)
    }
    L(tg, Je);
    Oa(tg[F], ud("LinearRing"));
    Ha(tg[F], function () {
        return this.Z[E]
    });
    db(tg[F], function (a) {
    ...
    var ug = We(Ue(tg, "google.maps.Data.LinearRing", !0));
    ...
    var wg = We(Ue(vg, "google.maps.Data.Polygon", !0));
    ...
    function Zg() {}
    Zg[F].route = function (a, b) {
        S("directions", function (c) {
            c.Lh(a, b, !0)
        })
    };
    var $g = Ze(Ue(Nf, "StreetViewPanorama"));
    ...
    function ch() {}
    ch[F].getDistanceMatrix = function (a, b) {
    ...
    function dh() {}
    dh[F].getElevationAlongPath = function (a, b) {
        S("elevation", function (c) {
            c.j(a, b)
        })
    };
    dh[F].getElevationForLocations = function (a, b) {
        S("elevation", function (c) {
            c.k(a, b)
        })
    };
    ...
    L(jh, Q);
    jh[F].url_changed = jh[F].driveFileId_changed = sa(jh[F], Ua(jh[F], function () {
        var a = this;
        S("kml", function (b) {
            b.k(a)
        })
    ...
    function jl(a, b) {
        ...
        var e = l.sin(b),
            f = l.cos(Wd(a.lat()));
        if (90 == c || -90 == d || 1E-6 > f) return new jg(new R(d, -180), new R(c, 180));
        e = Xd(l[mc](e / f));
        return new jg(new R(d, a.lng() - e), new R(c, a.lng() + e))
    };
    ...
    Wa(G, function () {
        var a = this.Jf(),
            b = this.If(),
            c = Dl(this);
        if (a && !a.j(this.R) || this.B != b || this.W != c) El(this.k), this.X(), this.B = b, this.W = c;
        this.R = a
    });
    ...
    G.ia = function () {
        ...
        this.k && e && (ll(this.k, e), e = a, a = this.k, e != a.src ? (El(a), ka(a, je(this, this.Kf, !0)), Sa(a, je(this, this.Kf, !1)), a.src = e) : !a[ad] && e && this.j[ib](a))
    };
    G.Kf = function (a) {
        var b = this.k;
        ka(b, null);
    ...
    function Tl(a, b) {
        ...
        d.noClear || Rl(a);
        var g = null;
        Ul(d.useStaticMap, f) && Mk && (g = new Al(a, eh, Nk()), P[u](g,
    ...
    function bm(a) {
        return a instanceof Lf ? cm(a) : new Lf(jf(a))
    }
    ...
    Qd(pm, {
        ...
        DirectionsTravelMode: Rg,
        DirectionsUnitSystem: Qg,
        DistanceMatrixService: ch,
